...
int main(){
    ...
    //floor
    std::cout << "Weight rounded to floor is : " << std::floor(weight) << std::endl; // output only the int part
    
    //ceil 
    std::cout << "Weight rounded to ceil is : " << std::ceil(weight) << std::endl; // round off the float
    ...
    double exponential = std::exp(10); // e^10
    ...
    std::cout << "Log ; to get 54.59, you would elevate e to the power of : "
             << std::log(54.59) << std::endl; // log(base e)
    ...
    std::cout << "To get 10000, you'd need to elevate 10 to the power of : "
                 << std::log10(10000) << std::endl; // log(base 10)
