...
int main()
{
	...
	cout << "\nThe first element after erasing is: " << v[0];
    cout << "\nVector element after erasing: ";
    for (int i = 0; i < v.size(); i++)
		cout << v[i] << " ";
	...
	v.emplace_back(20);
	n = v.size();
	cout << "\nThe last element after emplace insertion(back) is: " << v[n - 1];
    cout << "\nVector element after emplace insertion(back) is:";
    for (int i = 0; i < v.size(); i++)
		cout << v[i] << " ";
