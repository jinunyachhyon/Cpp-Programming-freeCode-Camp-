...
int main(){
   ...
   //std::cout << "p_scores1 size : " << std::size(p_scores) << std::endl; // Error --> p_scores1 is pointer and looses the property of an array
   /*
   for( auto s : p_scores1){ // Error --> p_scores1 is pointer and looses the property of an array
       std::cout << "value : " << s << std::endl;
   }
   */
