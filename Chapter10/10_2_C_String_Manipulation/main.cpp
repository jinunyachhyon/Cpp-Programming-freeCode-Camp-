...
// A C string is a sequence of characters in the C programming language, terminated by a null character ('\0').
...
int main(){
    ...
    std::cout << "sizeof(message1) : " << sizeof(message1) << std::endl; // array's size
	
	//strlen still works with decayed arrays (pointer)
    ...
    //Print out the comparison
    std::cout << "std::strcmp (" << string_data1 << "," << string_data2 << ") : "
        << std::strcmp(string_data1, string_data2) << std::endl; // Alabam'a' , Alabam'b'; a comes before b so --> -1
    ...
    //Print out the comparison
    std::cout << "std::strcmp (" << string_data1 << "," << string_data2 << ") : "
        << std::strcmp(string_data1, string_data2) << std::endl; // Ala'c'ama vs Ala'b'ama; c comes after b so --> +1
    ...
    const char* string_data7{ "Alabama" };
    const char* string_data8{ "Blabama" };
    size_t n{3};
    std::cout << std::endl;
    std::cout << "std::strncmp : " << std::endl;
    std::cout << "std::strncmp (" << string_data7 << "," << string_data8 << "," << n << ") : " 
              << std::strncmp(string_data7,string_data8,n) << std::endl; // compare n characters
              
    string_data7 = "aaaia";
    string_data8 = "aaance";
    
    std::cout << "std::strncmp (" << string_data7 << "," << string_data8 << "," << n << ") : " 
              << std::strncmp(string_data7,string_data8,n) << std::endl;
