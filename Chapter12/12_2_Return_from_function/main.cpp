...
int main(){
    ...
    // Compiler does an optimization here --> function creates a variable result, stores the value
    // So, while returning, it destroys the function's variable (result)
    // Thus the result_str now stores the returned value on the same address of function's variable (result)
